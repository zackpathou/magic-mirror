...
Module.register("compliments", {
	...
	defaults: {
		compliments: {
			anytime: ["t'es trop sexy!"],
			morning: ["Bonjour!", "Passe une bonne journée!", "Comment as tu dormi?"],
			afternoon: ["Salut beauté!", "t'es trop sexy!", "Bonne journée!"],
			evening: ["Wow, t'es trop sexy!", "t'es au top!", "Hey, sexy!"],
			"....-01-01": ["Bonne année!"]
		},
